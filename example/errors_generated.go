...
// This file was generated by herr at 2020-01-16 13:19:17.3773478 -0500 EST m=+0.008998401
package errors
...
func NewDebugErrorOneError(err error) error {
	return pkg_errors.WithStack(DebugErrorOneError{ Err: err })
}
...
func NewDebugErrorTwoError(err error) error {
	return pkg_errors.WithStack(DebugErrorTwoError{ Err: err })
}
...
func NewDebugErrorThreeError(err error) error {
	return pkg_errors.WithStack(DebugErrorThreeError{ Err: err })
}
...
func NewInvalidAndroidVersionError(err error) error {
	return pkg_errors.WithStack(InvalidAndroidVersionError{ Err: err })
}
...
func NewInvalidAndroidDeviceError(err error) error {
	return pkg_errors.WithStack(InvalidAndroidDeviceError{ Err: err })
}
...
func NewInvalidIOSDeviceError(err error) error {
	return pkg_errors.WithStack(InvalidIOSDeviceError{ Err: err })
}
