...
// This file was generated by herr at 2020-01-15 12:51:45.9348486 -0500 EST m=+0.007999401
package errors
...
func WrapDebugErrorOneError(err error) error {
	...
	return DebugErrorOneError{ Err: err }
}
...
func WrapDebugErrorTwoError(err error) error {
	...
	return DebugErrorTwoError{ Err: err }
}
...
func WrapDebugErrorThreeError(err error) error {
	...
	return DebugErrorThreeError{ Err: err }
}
...
func WrapInvalidAndroidVersionError(err error) error {
	...
	return InvalidAndroidVersionError{ Err: err }
}
...
func WrapInvalidAndroidDeviceError(err error) error {
	...
	return InvalidAndroidDeviceError{ Err: err }
}
...
func WrapInvalidIOSDeviceError(err error) error {
	...
	return InvalidIOSDeviceError{ Err: err }
}
